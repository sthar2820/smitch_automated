...
Built an automated pipeline to clean, transform, and prepare datasets for reporting, improving reliability and reducing manual effort.

### Business Intelligence Dashboards  
Developed Power BI dashboards to support leadership decision-making through clear and actionable insights.

### Stock Market Analysis  
Created a data-driven analysis pipeline using Python and machine learning techniques to evaluate market trends.
